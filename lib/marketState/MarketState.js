...
module.exports = (() => {
  ...
  function MarketStateInternal(handleProfileRequest, instance) {
    ...
    const _createProfile = (symbol, name, exchange, unitCode, pointValue, tickIncrement, additional) => {
      ...
      if (Object.prototype.hasOwnProperty.call(_profileCallbacks, symbol)) {
    ...
    const _processMessage = (message, _options) => {
    ...
    const _processExchangeMetadata = (id, description, timezoneDdf, timezoneExchange) => {
      if (Object.prototype.hasOwnProperty.call(_exchanges, id)) {
        return;
      }
  ...
  class MarketState {
     ...
     * @ignore
     */
    processMessage(message, _options) {
      return this._internal.processMessage(message, _options);
    }
